...
public class ElevatorConfigurationReader {
	...
	public static void showElevator() {
		...
		FloorPanelConfiguration.setTextType(GuiConfiguration.getFloorPanelDisplay());
			...
			//Added for alarm handling, Snigdha, CMPE 287, Fall 2011
		FloorPanelConfiguration.setNumberOfCars(numberOfCars);
		...
		//Setting alarm configuration, Snigdha, CMPE 287, Fall 2011
		AlarmConfiguration.setTextType(GuiConfiguration.getAlarmType());
