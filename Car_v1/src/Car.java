...
//		Code Changed By Phuc Le for Emergency Switch
		/* -------------------*/
		eIndicator = new EmergencyIndicator(userPanel.getEmergency());
		
		carUI = new CarUI(currentFloorNumber, carName, door, userPanel, doorPanel, eIndicator);
		return carUI;
		/* -------------------*/
...
//	Code Changed By Phuc Le for Emergency Switch
	/* -------------------*/
	@Override
	public void setEmergencyStatus() {
		if(carUI!=null)
			carUI.updateEmergencyStatus();
	}
	/* -------------------*/
	@Override
